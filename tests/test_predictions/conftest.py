...
@pytest.fixture(scope="module", params=["dummy"])
...
@pytest.fixture(scope="module", params=["train/KA1_DJI_0_0095_R.npy.lz4"])
...
def threshold(request):
    """Fixture to provide the threshold argument to api.predict."""
    return request.param
